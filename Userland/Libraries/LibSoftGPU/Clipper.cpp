...
bool Clipper::point_within_clip_plane(FloatVector4 const& vertex, ClipPlane const plane) const
{
    switch (plane) {
    case ClipPlane::LEFT:
...
Vertex Clipper::clip_intersection_point(Vertex const& p1, Vertex const& p2, ClipPlane const plane_index) const
{
