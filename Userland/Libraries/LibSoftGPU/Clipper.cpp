...
static constexpr bool point_within_clip_plane(FloatVector4 const& vertex, Clipper::ClipPlane const plane)
{
    using enum Clipper::ClipPlane;
    switch (plane) {
    case LEFT:
...
static Vertex clip_intersection_point(Vertex const& p1, Vertex const& p2, Clipper::ClipPlane const plane)
{
...
static void clip_plane(Vector<Vertex>& read_list, Vector<Vertex>& write_list, Clipper::ClipPlane const plane)
{
