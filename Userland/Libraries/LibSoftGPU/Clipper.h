...
private:
    bool point_within_clip_plane(FloatVector4 const& vertex, ClipPlane const plane) const;
    Vertex clip_intersection_point(Vertex const& vec, Vertex const& prev_vec, ClipPlane const plane_index) const;
